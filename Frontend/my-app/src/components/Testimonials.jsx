...
const Testimonials = () => {
  return (
    <div className="bg-gradient-to-b from-gray-900 via-blue-900 to-gray-900 py-14 sm:py-20 md:py-28">
          ...
          <div className="w-full text-white md:w-1/2">
            <div className="mb-3 flex items-center gap-2 sm:mb-4">
              <div className="flex gap-1">
                ...
                <div className="h-2.5 w-2.5 rounded-full bg-blue-600 sm:h-3 sm:w-3"></div>
              </div>
              <h3 className="text-base font-medium text-blue-300 sm:text-lg md:text-xl">How lessons work</h3>
            </div>
            ...
            <div className="mb-8 grid grid-cols-1 gap-4 sm:mb-10 md:grid-cols-2 md:gap-6">
              <div className="flex items-start gap-2 sm:gap-3">
                <FaVideo className="mt-0.5 shrink-0 text-lg text-blue-400 sm:text-xl" />
                <p className="text-sm font-medium sm:text-base">HD lessons you can pause anytime</p>
              </div>
              
              <div className="flex items-start gap-2 sm:gap-3">
                <FaClipboardList className="mt-0.5 shrink-0 text-lg text-blue-400 sm:text-xl" />
                <p className="text-sm font-medium sm:text-base">Syllabus &amp; outcomes on every course page</p>
              </div>
              
              <div className="flex items-start gap-2 sm:gap-3">
                <FaBook className="mt-0.5 shrink-0 text-lg text-blue-400 sm:text-xl" />
                <p className="text-sm font-medium sm:text-base">Extra resources when instructors include them</p>
              </div>
              
              <div className="flex items-start gap-2 sm:gap-3">
                <FaUsers className="mt-0.5 shrink-0 text-lg text-blue-400 sm:text-xl" />
            ...
            <Link
              to="/courses"
              className="inline-flex items-center gap-2 rounded-full bg-blue-600 px-6 py-2.5 text-sm text-white transition-all hover:bg-blue-700 sm:px-8 sm:py-3 sm:text-base"
            >
