...
const CourseDetail = () => {
  ...
  // Get current lesson
  const currentLesson = courseData?.modules[activeModule]?.sections[0]?.lessons[activeLesson];
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
              <div className="p-5 border-b border-gray-100">
                ...
                <div className="text-sm text-gray-500 mt-1">
                  {totalLessons} lessons • {courseData.modules.length} modules
                </div>
              </div>
                ...
                {courseData.modules.map((module, moduleIndex) => (
                  <div key={module._id} className="p-0">
                    <div className="flex justify-between items-center p-4 cursor-pointer bg-gray-50">
                      ...
                      <div className="text-xs text-gray-500">{module.sections[0]?.lessons.length || 0} lessons</div>
                    </div>
                    
                    <div>
                      {module.sections[0]?.lessons.map((lesson, lessonIndex) => (
                        <div 
                          key={lesson._id}
                ...
                <div className="flex flex-wrap justify-between items-center">
                  ...
                  <div className="flex space-x-2 mt-2 md:mt-0">
                    <button 
                      ...
                      onClick={() => {
                        if (activeLesson > 0) {
                          ...
                          setActiveLesson(courseData.modules[activeModule - 1].sections[0].lessons.length - 1);
                        }
                      }}
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button 
                      ...
                      onClick={() => {
                        if (activeLesson < courseData.modules[activeModule].sections[0].lessons.length - 1) {
                          setActiveLesson(activeLesson + 1);
